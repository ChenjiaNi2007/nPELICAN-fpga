...
| Phase 2 retype | 2026-06-12 | fpga_model_qat_best.pt | e57d904+ (pending) | TBD | TBD | TBD | TBD | TBD (remote) | TBD | local provisional (UB toolchain): 72/200 exact, max|Δ|=1.06 — up from 0/200 baseline; REMOTE Vitis csim pending. Per-stage types wired; momenta widened to <36,12>. |
