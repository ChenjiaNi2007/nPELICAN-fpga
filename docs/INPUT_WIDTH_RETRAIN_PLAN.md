...
| 9 | 1 | <9,8> (±128 / 2⁻¹) | 0.9320 | owed | csynth 281.1k / 50.2k / **752** (15 cyc, II=1); **vsynth 97.2k / 22.5k / 998** | ≈ pmu-10 (curve plateaus 10→9); k=W−9 trend BROKE — model tightened clip to ±128 rather than coarsen the LSB; dot scale 2². vsynth DSP is 246 ABOVE csynth — Vivado re-inferred DSPs from HLS fabric logic; csynth calibration is dead below the threshold |
